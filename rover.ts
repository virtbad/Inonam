...
class Rover {
  ...
  public drive(direction: DriveDirection, unit: Units, repetitions: number, speed: number = config.defaultRoverMotorSpeed): boolean {
  ...
  public steer(direction: SteerDirection, degrees: number, speed: number = config.defaultRoverMotorSpeed): boolean {
    ...
    let run: { speed: number; degrees: number } = { speed: direction * speed, degrees: 0 };
